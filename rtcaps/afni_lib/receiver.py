...
print(os.path.isdir('/Users/rubinmar/Downloads/afni/src/python_scripts/afnipy'))

# Add the absolute path of afnipy to sys.path
sys.path.append('/Users/rubinmar/Downloads/afni/src/python_scripts/afnipy')
