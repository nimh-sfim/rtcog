...
from rtcap_lib import kalman_filter_mv
...
out = unmask_fMRI_img(Data_InMask_Step01, Mask_Img, '/data/SFIMJGC_HCP7T/PRJ_rtCAPs/PrcsData/TECH07/D01_RT_Run01/TestMV_Step01.nii')
out = unmask_fMRI_img(Data_InMask_Step02, Mask_Img, '/data/SFIMJGC_HCP7T/PRJ_rtCAPs/PrcsData/TECH07/D01_RT_Run01/TestMV_Step02.nii')
out = unmask_fMRI_img(Data_InMask_Step03, Mask_Img, '/data/SFIMJGC_HCP7T/PRJ_rtCAPs/PrcsData/TECH07/D01_RT_Run01/TestMV_Step03.nii')
for i,lab in enumerate(nuisance_labels):
    data = Regressor_Coeffs[i,:,:]
    out = unmask_fMRI_img(data, Mask_Img, '/data/SFIMJGC_HCP7T/PRJ_rtCAPs/PrcsData/TECH07/D01_RT_Run01/TestMV_'+lab+'.nii')
...
for cap_lab in tqdm(CAP_labels):
    ...
    mySVR.fit(Data_InMask_Step03[:,Vols4Training].T,Training_Labels)
    SVRs[cap_lab] = mySVR
