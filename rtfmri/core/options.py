...
class Options:
     ...
     def parse_cli_args(cls, argv=None):
          ...
          parser_dec.add_argument("--svr_win_activate", help="Activate windowing of individual volumes prior to hit estimation", dest="hit_dowin", action="store_true", default=None)
